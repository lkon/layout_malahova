	...
	var date = (function(){
		...
		getRecipeFromServer = function(callback, query) {
		    var	request = new XMLHttpRequest(),
				 ...
				 * @type {String}
				 */	    
				urlWithQuery = 'js/get_recipe_from_base.php?date=' + query;
	...
	var drawCanvas = (function(){
		return {
			...
			init : function () {
				...
				img.src = 'blocks/b-advice/b-advice__bg.jpg';
	...
	getAdviceXHR = (function(){
		...
		var	getResponse = function(request) {
			...
			num = (function(){
			     ...
			     */
			   	...
			   	getAmountAdvs( "js/get_advice_txt.php", 
			  				 	/**
		...
		return { 
			...
			evt.addListener(start, 'click', function(){ 
				 ...
				 * @type {String}  
				 */
				var url = "js/get_advice_txt.php?num=" + num();
...
evt.addListener(window, "load", function() {
			tags.start();			
			slideshow.present();
			slideshow.refresh();
